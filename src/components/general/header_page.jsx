...
// import "../../assets/css/header_page.scss";
// import logoMG from "../../assets/img/logo_main.jpg";

export function HeaderPage({ titulo }) {
  const sidebarRef = useRef(null);
  const navigate = useNavigate();

  const [loginUserVisible, setLoginUserVisible] = useState(false);
  const [notificationVisible, setNotificationVisible] = useState(false);
  const [mensajesVisible, setMensajesVisible] = useState(false);
  ...
  const mensajeVisibility = () => {
    setMensajesVisible(!mensajesVisible);
  ...
  const notificationVisibility = () => {
    ...
    setMensajesVisible(false);
    setLoginUserVisible(false);
  };

  const loginUserVisibility = () => {
    setLoginUserVisible(!loginUserVisible);
    setNotificationVisible(false);
    setMensajesVisible(false);
  };
  ...
  return (
    <div className="header-principal container-fluid ps-3 pe-3">
      <div className="d-flex align-items-center justify-content-between text-center ms-3 me-3 w-100">
        <div className="">SISTEMA DE SEGURIDAD</div>
        <div className="fw-semibold fs-6">{titulo}</div>
        <div className="position-relative ">
          <div className="d-flex justify-content-center align-items-center g-2">
            <div className="d-flex justify-content-center position-relative">
              <button className="notif-icon bg-transparent border border-0" onClick={notificationVisibility}>
                <svg
              ...
              {notificationVisible && (
                <ul className="container-lista-notif">
                  <li className="item-notif-header">
                  ...
                  <li className="item-notif">
                    ...
                    <div>
                      <h4>Lorem Ipsum</h4>
                      <span>Quae dolorem earum veritatis oditseno</span>
                  ...
                  <li className="item-notif-footer">
            ...
            <div className="d-flex justify-content-center position-relative">
              <button className="notif-icon bg-transparent border border-0" onClick={mensajeVisibility}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="22"
                  height="22"
                  fill="currentColor"
                  className="bi bi-chat-left-text text-dark"
                  viewBox="0 0 16 16"
                >
            ...
            <div className="d-flex login-usuario">
              <button className="perfil-btn" onClick={loginUserVisibility}>
                <img
                  src={null}
                  alt="Profile"
                  className="img-perfil rounded-circle"
                />
                <span>Elias Marcos</span>
              </button>
              {loginUserVisible && (
                <div
                  className={`elemento input ${
                    loginUserVisible ? "visible" : ""
                  }`}
                >
